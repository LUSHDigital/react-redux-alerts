...
var Alert = (function (_Component) {
  ...
  Alert.prototype.isDismissible = function isDismissible() {
    ...
    console.log(typeof alert.alert.dismissible !== undefined && alert.alert.dismissible);
  ...
  Alert.prototype.render = function render() {
    ...
    if (alert) {
      return _react2['default'].createElement(
        AlertWrapper,
        { className: 'alert ' + alert.alert.type, colours: colours, time: alert.alert.time, dismissible: this.isDismissible() },
